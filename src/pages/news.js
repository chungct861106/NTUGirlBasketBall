...
export default function News() {
  ...
  const [images, setImages] = useState([
    "https://scontent-tpe1-1.xx.fbcdn.net/v/t1.6435-9/88248336_2748659698502400_4995492301816987648_n.jpg?_nc_cat=107&ccb=1-3&_nc_sid=8bfeb9&_nc_ohc=jcuNQBefKZMAX8P7n8l&_nc_ht=scontent-tpe1-1.xx&oh=af08b5edc39adfd85ae9642cc23b062e&oe=60CF4791",
          ...
          {images.map((image, index) => {
            return (
              <ContentStyled key={index}>
                ...
                ></StyledImage>
                {edit && (
                  <EditButton onClick={() => setEdit(true)}>編輯</EditButton>
                )}
              </ContentStyled>
            );
          })}
